...
public enum RocketAdmob {
    ...
    public class BannerAdView: GADBannerView {
        ...
        public static func factory(adUnitID: String, vcToDisplay: UIViewController, didReceiveAd: (() -> Void)? = nil) -> BannerAdView {
...
public extension RocketAdmob {
    class FullscreenAd: NSObject, GADFullScreenContentDelegate {
        public static func factory(adID: String) -> FullscreenAd {
        ...
        public func show(inVC vc: UIViewController, dismissCallback c: (() -> Void)? = nil) {
            dismissCallback = c
